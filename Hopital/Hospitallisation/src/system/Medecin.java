...
public class Medecin extends javax.swing.JFrame {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        try {
            Class.forName("org.sqlite.JDBC");
            con=DriverManager.getConnection("jdbc:sqlite:hopital.db");
            String sql="insert into medecin(id,nom,idservice) values(?,?,?);";
            pst=con.prepareStatement(sql);
            pst.setString(1, textId.getText());
...
public final void TableMedecin(){
    String[] auteur={"Identifiant","Nom","Idservice"};
...
public final void TableMedecinRecherche(String valeur){
    ...
    String[] afficher=new String[4];
    DefaultTableModel model=new DefaultTableModel(null,auteur);
    String sql="select * from medecin where id like'%"+valeur+"%'";
    try {
        Class.forName("org.sqlite.JDBC");
        con=DriverManager.getConnection("jdbc:sqlite:hopital.db");
        java.sql.Statement st =con.createStatement();
 ...
 TableMedecinRecherche(textRecherche.getText());
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            Class.forName("org.sqlite.JDBC");
            con=DriverManager.getConnection("jdbc:sqlite:hopital.db");
            String sql="update medecin set nom=?,idservice=? where id=?;";
            pst=con.prepareStatement(sql);
