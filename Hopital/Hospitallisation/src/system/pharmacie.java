...
public class pharmacie extends javax.swing.JFrame {
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(textNom, javax.swing.GroupLayout.PREFERRED_SIZE, 194, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(59, 59, 59)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        try {
            Class.forName("org.sqlite.JDBC");
            con=DriverManager.getConnection("jdbc:sqlite:hopital.db");
            String sql="insert into pharmacie(id,nom) values(?,?);";
            pst=con.prepareStatement(sql);
            pst.setString(1, textId.getText());
...
public final void TableFournisseurRecherche(String valeur){
    ...
    String[] afficher=new String[2];
    DefaultTableModel model=new DefaultTableModel(null,auteur);
    String sql="select * from pharmacie where id like'%"+valeur+"%'";
    try {
        Class.forName("org.sqlite.JDBC");
        con=DriverManager.getConnection("jdbc:sqlite:hopital.db");
        java.sql.Statement st =con.createStatement();
...
TableFournisseurRecherche(textRecherche.getText());
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            Class.forName("org.sqlite.JDBC");
            con=DriverManager.getConnection("jdbc:sqlite:hopital.db");
            String sql="update pharmacie set nom=? where id=?;";
            pst=con.prepareStatement(sql);
