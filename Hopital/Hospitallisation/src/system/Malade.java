...
public class Malade extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        textDate.setForeground(new java.awt.Color(51, 51, 51));
        textDate.setText(" ");
        ...
        textNationalite.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        textNationalite.setForeground(new java.awt.Color(51, 51, 51));
        textNationalite.setText(" ");
        textNationalite.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                textNationaliteActionPerformed(evt);
            }
        });
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addComponent(textDate, javax.swing.GroupLayout.PREFERRED_SIZE, 163, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            ...
                            .addComponent(textNationalite, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jPanel2, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
       try {
            ...
            String sql="delete from malade where id=?;";
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        try {
            Class.forName("org.sqlite.JDBC");
            con=DriverManager.getConnection("jdbc:sqlite:hopital.db");
            String sql="insert into malade(id,nom,idservice,idunite,idchambre) values(?,?,?,?,?);";
            pst=con.prepareStatement(sql);
            pst.setString(1, textId.getText());
            pst.setString( 2, textNom.getText());
            pst.setString( 3, textPrenom.getText());
            pst.setString( 4, textDate.getText());
            pst.setString( 5, textNationalite.getText());
            pst.executeUpdate();
            con.close();
...
public final void TableMalade(){
    String[] auteur={"Identifiant","Nom","Service","Unite_Fonctionnelle","Chambre"};
    ...
    try {
        ...
        while(rs.next()){
            ...
            afficher[3]=rs.getString("idunite");
            afficher[4]=rs.getString("idchambre");
...
public final void TableMaladeRecherche(String valeur){
    String[] auteur={"Identifiant","Nom","Service","Unite_Fonctionnelle","Chambre"};
    String[] afficher=new String[6];
    DefaultTableModel model=new DefaultTableModel(null,auteur);
    String sql="select * from malade where id like'%"+valeur+"%'";
    try {
        Class.forName("org.sqlite.JDBC");
        con=DriverManager.getConnection("jdbc:sqlite:hopital.db");
        java.sql.Statement st =con.createStatement();
...
TableMaladeRecherche(textRecherche.getText());
        // TODO add your handling code here:
    }//GEN-LAST:event_textRechercheActionPerformed

    private void textNationaliteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_textNationaliteActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_textNationaliteActionPerformed

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            Class.forName("org.sqlite.JDBC");
            con=DriverManager.getConnection("jdbc:sqlite:hopital.db");
            String sql="update malade set nom=?,idservice=?,idunite=?,idchambre=? where id=?;";
            pst=con.prepareStatement(sql);
            ...
            pst.setString( 4, textNationalite.getText());
            pst.executeUpdate();
            con.close();
    ...
    private void jTable1MouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseReleased
        ...
        textNationalite.setText(model.getValueAt(i,4).toString());
