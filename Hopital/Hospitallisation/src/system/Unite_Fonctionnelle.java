 ...
 */
public class Unite_Fonctionnelle extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText(" Unites Fonctionnelle");
        ...
        textId2.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        textId2.setForeground(new java.awt.Color(51, 51, 51));
        textId2.setText(" ");
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)))
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(textId2, javax.swing.GroupLayout.DEFAULT_SIZE, 163, Short.MAX_VALUE)
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            ...
                            .addComponent(textId2, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE))))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
       try {
            ...
            String sql="delete from unite_fonctionnelle where id=?;";
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        try {
            Class.forName("org.sqlite.JDBC");
            con=DriverManager.getConnection("jdbc:sqlite:hopital.db");
            String sql="insert into unite_fonctionnelle(id,nom,idservice) values(?,?,?);";
            pst=con.prepareStatement(sql);
            pst.setString(1, textId.getText());
            pst.setString( 2, textNom.getText());
            pst.setString( 3, textId2.getText());
            pst.executeUpdate();
            con.close();
...
public final void TableUnite(){
    String[] examen={"Identifiant","Nom","IdService"};
    String[] afficher=new String[4];
    DefaultTableModel model=new DefaultTableModel(null,examen);
    String sql="select * from unite_fonctionnelle;";
    try {
        Class.forName("org.sqlite.JDBC");
        con=DriverManager.getConnection("jdbc:sqlite:hopital.db");
...
public final void TableExamenRecherche(String valeur){
    String[] auteur={"Identifiant","Nom","IdMedecin"};
    String[] afficher=new String[4];
    DefaultTableModel model=new DefaultTableModel(null,auteur);
    String sql="select * from unite_fonctionnelle where id like'%"+valeur+"%'";
    try {
        Class.forName("org.sqlite.JDBC");
        con=DriverManager.getConnection("jdbc:sqlite:hopital.db");
        java.sql.Statement st =con.createStatement();
...
TableExamenRecherche(textRecherche.getText());
        // TODO add your handling code here:
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            Class.forName("org.sqlite.JDBC");
            con=DriverManager.getConnection("jdbc:sqlite:hopital.db");
            String sql="update unite_fonctionnelle set nom=?,idservice=? where id=?;";
            pst=con.prepareStatement(sql);
            pst.setString(3, textId.getText());
            pst.setString( 1, textNom.getText());
            pst.setString( 2, textId2.getText());
            pst.executeUpdate();
            con.close();
    ...
    private void JTable1MouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_JTable1MouseReleased
        ...
        textId2.setText(model.getValueAt(i,1).toString());
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new Unite_Fonctionnelle().setVisible(true);
        });
    }
