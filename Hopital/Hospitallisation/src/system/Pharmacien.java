...
public class Pharmacien extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setSize(new java.awt.Dimension(1121, 548));
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        try {
            Class.forName("org.sqlite.JDBC");
            con=DriverManager.getConnection("jdbc:sqlite:hopital.db");
            String sql="insert into pharmacien(id,nom,idpharmacie) values(?,?,?);";
            pst=con.prepareStatement(sql);
            pst.setString(1, textId.getText());
...
public final void TableExamen(){
    String[] examen={"Identifiant","Nom","Id Pharmacie"};
    ...
    try {
        ...
        while(rs.next()){
            ...
            afficher[2]=rs.getString("idpharmacie");
...
public final void TableExamenRecherche(String valeur){
    String[] auteur={"Identifiant","Nom","Id Pharmacie"};
    String[] afficher=new String[4];
    DefaultTableModel model=new DefaultTableModel(null,auteur);
    String sql="select * from pharmacien where id like'%"+valeur+"%'";
    try {
        Class.forName("org.sqlite.JDBC");
        con=DriverManager.getConnection("jdbc:sqlite:hopital.db");
        java.sql.Statement st =con.createStatement();
...
TableExamenRecherche(textRecherche.getText());
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            Class.forName("org.sqlite.JDBC");
            con=DriverManager.getConnection("jdbc:sqlite:hopital.db");
            String sql="update pharmacien set nom=?, idpharmacie=? where id=?;";
            pst=con.prepareStatement(sql);
    ...
    private void JTable1MouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_JTable1MouseReleased
        ...
        textId2.setText(model.getValueAt(i,2).toString());
