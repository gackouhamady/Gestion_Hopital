...
public class Examen extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText(" Examens Medical");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        try {
            Class.forName("org.sqlite.JDBC");
            con=DriverManager.getConnection("jdbc:sqlite:hopital.db");
            String sql="insert into examen(id,nom,idmedecin) values(?,?,?);";
            pst=con.prepareStatement(sql);
            pst.setString(1, textId.getText());
...
public final void TableExamen(){
    String[] examen={"Identifiant","Nom","IdMedecin"};
    ...
    try {
        ...
        while(rs.next()){
            ...
            afficher[2]=rs.getString("idmedecin");
...
public final void TableExamenRecherche(String valeur){
    ...
    String sql="select * from examen where nom like'%"+valeur+"%'";
    try {
        Class.forName("org.sqlite.JDBC");
        con=DriverManager.getConnection("jdbc:sqlite:hopital.db");
        java.sql.Statement st =con.createStatement();
 ...
 TableExamenRecherche(textRecherche.getText());
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            Class.forName("org.sqlite.JDBC");
            con=DriverManager.getConnection("jdbc:sqlite:hopital.db");
            String sql="update examen set nom=?,idmedecin=? where id=?;";
            pst=con.prepareStatement(sql);
