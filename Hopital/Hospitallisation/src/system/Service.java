...
public class Service extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setSize(new java.awt.Dimension(1053, 570));
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        try {
            Class.forName("org.sqlite.JDBC");
            con=DriverManager.getConnection("jdbc:sqlite:hopital.db");
            String sql="insert into service(id,nom,specialite) values(?,?,?);";
            pst=con.prepareStatement(sql);
            pst.setString(1, textId.getText());
...
public final void TableExamen(){
    String[] examen={"Identifiant","Nom","Specialite"};
...
public final void TableExamenRecherche(String valeur){
    String[] auteur={"Identifiant","Nom","Specialite"};
    String[] afficher=new String[4];
    DefaultTableModel model=new DefaultTableModel(null,auteur);
    String sql="select * from service where id like'%"+valeur+"%'";
    try {
        Class.forName("org.sqlite.JDBC");
        con=DriverManager.getConnection("jdbc:sqlite:hopital.db");
        java.sql.Statement st =con.createStatement();
...
TableExamenRecherche(textRecherche.getText());
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            Class.forName("org.sqlite.JDBC");
            con=DriverManager.getConnection("jdbc:sqlite:hopital.db");
            String sql="update service set nom=?,specialite=? where id=?;";
            pst=con.prepareStatement(sql);
